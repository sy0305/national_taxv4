...
$(document).ready(function(){
	...
	$('.banner_a img').css('margin-left','-'+w_banner+'px');
	 ...
	 $("#set").find("option[value='${slip.slip_mouth}']").attr("selected",true);
	 $("#years").find("option[value='${slip.slip_year}']").attr("selected",true);
...
<div class="second clearfix">
    ...
    <div class="scd_r">
        ...
        <div class="scd_rm">
            ...
            <div class="scd_rmb">
                <form id="mainForm" action="${basePath}/slip/doupdateInfo" autocomplete="on"  method="post">
                
                	<input type="hidden" id="basePath" value="${basePath}"/>
                    输入：
                    <select style="font-size: 8px" name="slip_year"  value="${slip.slip_year}" id="years">
                        <option value ="0">请输入年份</option>
...
<%} %>
                    ...
                    <select style="font-size: 8px" name="slip_mouth" value="${slip.slip_mouth}" id="set">
...
<!--                     所在部门: <input type="text" name="user_department">
                    ...
                    基本工资(元):<input type="text" name="base_pay"  value="${slip.base_pay}">
                    </br> </br>
                    业务提成(元):<input type="text" name="business_pay" value="${slip.business_pay}">
                    </br> </br>
                    五险一金合计(元):<input type="text" name="welfare_pay" value="${slip.welfare_pay}">
                    </br> </br>
                    事假(元):<input type="text" name="leave_pay" value="${slip.leave_pay}">
                    </br> </br>
                    个税(元):<input type="text" name="tax_pay" value="${slip.tax_pay}">
                    </br> </br>
                    实发工资(元):<input type="text" name="real_pay" value="${slip.real_pay}">
                </br></br>
